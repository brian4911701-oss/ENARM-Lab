...
// Para Pediatría, el código de especialidad es 'ped'
let pedia2 = parseTextFile('pedia2_text.txt', 'ped');

fs.writeFileSync('parsed_pedia2.json', JSON.stringify(pedia2, null, 2));
console.log(`Parsed ${pedia2.length} new pedia cases from pedia2_text.txt`);

// Merge with questions.js directly
let oldQ = require('./questions.js');
let combined = oldQ.concat(pedia2);
...
console.log(`Successfully combined ${oldQ.length} old questions with ${pedia2.length} new cases. New total: ${combined.length}`);
